...
aws ecs update-service --service arn:aws:ecs:ap-northeast-2:494634321140:service/beta-hub/beta-live-graphql-service --force-new-deployment --cluster beta-hub --region ap-northeast-2