...
// NOTE: The Private/Public keys in this file is randomly generated at https://jwt.io. It would
// be preferred that we generate our own keys and input here. Another option would be to load
// the keys from files on disk. Perhaps in another implementation of IKeyProvider.
...
export const ValidIssuer: string[] = ["calmid"];
...
export class DebugKeyProvider implements IKeyProvider {
    ...
    getCertificateForIssuer (_issuerId: string): string | Buffer | undefined {
        return PublicKey;
    }

    getValidIssuer (_issuerId: string) : string | string[] | undefined {
        return ValidIssuer;
    }
